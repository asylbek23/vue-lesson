  ...
  <div id="app">
    ...
    <div class="catalog">
      <div class="container">
        ...
        <!-- Header -->
        <div class="catalog__header header">
          <div class="header__favorites favorites">
            <span>Favorites</span>
            <span class="favorites__amount">{{ favorites.length }}</span>
          </div>
          <div class="header__title">My catalog</div>
          <div class="header__basket basket">
            <span>Корзина</span>
            <div class="basket__amount">{{ baskets.length }}</div>
          </div>
        </div>
        ...
        <div class="catalog__items">
          <div class="catalog__item" v-for="item in products" :key="item.id">
            <div class="catalog__item-card" v-if="item.price > 500">
              <img class="catalog__img" v-bind:src="item.thumbnail" width="200" height="200" alt="product image">
    ...
    <!-- <img v-bind:src="thumbnail" v-if="price > 500"> -->
